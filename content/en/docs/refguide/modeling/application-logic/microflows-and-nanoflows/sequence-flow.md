...
{{% alert color="info" %}}
The orthogonal flow shape is a beta feature. To use it, you first need to enable it in the **Preferences** dialog box, as described in the [Enabling the Orthogonal Flow Shape](#enable-orthogonal) section below.
{{% /alert %}}
